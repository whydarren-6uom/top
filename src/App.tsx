    ...
    <PaymentDataProvider data={data}>
      <main className="mx-auto max-w-7xl px-4 pb-20 pt-4 sm:px-6 lg:px-8">
        <div className="space-y-5">
          ...
          <div className="sticky top-0 z-10 -mx-4 border-y border-zinc-200 bg-white/95 px-4 py-3 backdrop-blur dark:border-zinc-800 dark:bg-zinc-900/95 sm:mx-0 sm:rounded-lg sm:border">
